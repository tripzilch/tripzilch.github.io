class Vec2 {
  ...
  smul(a) { this.x *= a; this.y *= a; return this; }
...
function fill_shape(c, s, o=Vec2.ZERO) {
  const x = o.x, y = o.y;
  ctx.beginPath();
  ctx.moveTo(s[0].x + x, s[0].y + y);
...
function stroke_shape(col, lw, path, closed=false, o=Vec2.ZERO) {
  const x = o.x, y = o.y;
  ctx.beginPath();
